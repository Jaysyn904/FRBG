...
// Consolidated functions into own include - LordValinar (11/12/2023)
#include "lv_inc"
...
int DetermineConversation(object oCreature, object oSpeaksWith, int bPrivate=FALSE, int bPlayHello=FALSE, int bZoom=TRUE)
{
    ...
    if(!bSuccess)
    {
        AssignCommand(oCreature, ActionStartConversation(oSpeaksWith, "", bPrivate, bPlayHello));
    }
...
{
    object oMod = GetModule();
    if (GetHasFeat(DEITY_Akadi,oPC))             return GetLocalInt(oMod,"DEITY_Akadi");
    if (GetHasFeat(DEITY_Amaunator,oPC))         return GetLocalInt(oMod,"DEITY_Amaunator");
    if (GetHasFeat(DEITY_Auril,oPC))             return GetLocalInt(oMod,"DEITY_Auril");
    if (GetHasFeat(DEITY_Azuth,oPC))             return GetLocalInt(oMod,"DEITY_Azuth");
    if (GetHasFeat(DEITY_Bane,oPC))              return GetLocalInt(oMod,"DEITY_Bane");
    if (GetHasFeat(DEITY_Beshaba,oPC))           return GetLocalInt(oMod,"DEITY_Beshaba");
    if (GetHasFeat(DEITY_Bhaal,oPC))             return GetLocalInt(oMod,"DEITY_Bhaal");
    if (GetHasFeat(DEITY_Chauntea,oPC))          return GetLocalInt(oMod,"DEITY_Chauntea");
    if (GetHasFeat(DEITY_Cyric,oPC))             return GetLocalInt(oMod,"DEITY_Deneir");
    if (GetHasFeat(DEITY_Deneir,oPC))            return GetLocalInt(oMod,"DEITY_Deneir");
    if (GetHasFeat(DEITY_Dwarven_Powers,oPC))    return GetLocalInt(oMod,"DEITY_Dwarven_Powers");
    if (GetHasFeat(DEITY_Eldath,oPC))            return GetLocalInt(oMod,"DEITY_Eldath");
    if (GetHasFeat(DEITY_Elven_Powers,oPC))      return GetLocalInt(oMod,"DEITY_Elven_Powers");
    if (GetHasFeat(DEITY_Finder_Wyvernspur,oPC)) return GetLocalInt(oMod,"DEITY_Finder_Wyvernspur");
    if (GetHasFeat(DEITY_Garagos,oPC))           return GetLocalInt(oMod,"DEITY_Garagos");
    if (GetHasFeat(DEITY_Gargauth,oPC))          return GetLocalInt(oMod,"DEITY_Gargauth");
    if (GetHasFeat(DEITY_Gnomish_Powers,oPC))    return GetLocalInt(oMod,"DEITY_Gnomish_Powers");
    if (GetHasFeat(DEITY_Gond,oPC))              return GetLocalInt(oMod,"DEITY_Gond");
    if (GetHasFeat(DEITY_Grumbar,oPC))           return GetLocalInt(oMod,"DEITY_Grumbar");
    if (GetHasFeat(DEITY_Gwaeron_Windstrom,oPC)) return GetLocalInt(oMod,"DEITY_Gwaeron_Windstrom");
    if (GetHasFeat(DEITY_Halfling_Powers,oPC))   return GetLocalInt(oMod,"DEITY_Halfling_Powers");
    if (GetHasFeat(DEITY_Helm,oPC))              return GetLocalInt(oMod,"DEITY_Helm");
    if (GetHasFeat(DEITY_Hoar,oPC))              return GetLocalInt(oMod,"DEITY_Hoar");
    if (GetHasFeat(DEITY_Ibrandul,oPC))          return GetLocalInt(oMod,"DEITY_Ibrandul");
    if (GetHasFeat(DEITY_Ilmater,oPC))           return GetLocalInt(oMod,"DEITY_Ilmater");
    if (GetHasFeat(DEITY_Ishtisha,oPC))          return GetLocalInt(oMod,"DEITY_Ishtisha");
    if (GetHasFeat(DEITY_Jergal,oPC))            return GetLocalInt(oMod,"DEITY_Jergal");
    if (GetHasFeat(DEITY_Karsus,oPC))            return GetLocalInt(oMod,"DEITY_Karsus");
    if (GetHasFeat(DEITY_Kelemvor,oPC))          return GetLocalInt(oMod,"DEITY_Kelemvor");
    if (GetHasFeat(DEITY_Kossuth,oPC))           return GetLocalInt(oMod,"DEITY_Kossuth");
    if (GetHasFeat(DEITY_Lathander,oPC))         return GetLocalInt(oMod,"DEITY_Lathander");
    if (GetHasFeat(DEITY_Leira,oPC))             return GetLocalInt(oMod,"DEITY_Leira");
    if (GetHasFeat(DEITY_Lliira,oPC))            return GetLocalInt(oMod,"DEITY_Lliira");
    if (GetHasFeat(DEITY_Loviatar,oPC))          return GetLocalInt(oMod,"DEITY_Loviatar");
    if (GetHasFeat(DEITY_Lurue,oPC))             return GetLocalInt(oMod,"DEITY_Lurue");
    if (GetHasFeat(DEITY_Malar,oPC))             return GetLocalInt(oMod,"DEITY_Malar");
    if (GetHasFeat(DEITY_Mask,oPC))              return GetLocalInt(oMod,"DEITY_Mask");
    if (GetHasFeat(DEITY_Mielikki,oPC))          return GetLocalInt(oMod,"DEITY_Mielikki");
    if (GetHasFeat(DEITY_Milil,oPC))             return GetLocalInt(oMod,"DEITY_Milil");
    if (GetHasFeat(DEITY_Moander,oPC))           return GetLocalInt(oMod,"DEITY_Moander");
    if (GetHasFeat(DEITY_Myrkul,oPC))            return GetLocalInt(oMod,"DEITY_Myrkul");
    if (GetHasFeat(DEITY_Mystra,oPC))            return GetLocalInt(oMod,"DEITY_Mystra");
    if (GetHasFeat(DEITY_Nobanion,oPC))          return GetLocalInt(oMod,"DEITY_Nobanion");
    if (GetHasFeat(DEITY_Oghma,oPC))             return GetLocalInt(oMod,"DEITY_Oghma");
    if (GetHasFeat(DEITY_Orcish_Powers,oPC))     return GetLocalInt(oMod,"DEITY_Orcish_Powers");
    if (GetHasFeat(DEITY_Red_Knight,oPC))        return GetLocalInt(oMod,"DEITY_Red_Knight");
    if (GetHasFeat(DEITY_Savras,oPC))            return GetLocalInt(oMod,"DEITY_Savras");
    if (GetHasFeat(DEITY_Selune,oPC))            return GetLocalInt(oMod,"DEITY_Selune");
    if (GetHasFeat(DEITY_Shar,oPC))              return GetLocalInt(oMod,"DEITY_Shar");
    if (GetHasFeat(DEITY_Sharess,oPC))           return GetLocalInt(oMod,"DEITY_Sharess");
    if (GetHasFeat(DEITY_Shaundakul,oPC))        return GetLocalInt(oMod,"DEITY_Shaundakul");
    if (GetHasFeat(DEITY_Shiallia,oPC))          return GetLocalInt(oMod,"DEITY_Shiallia");
    if (GetHasFeat(DEITY_Siamorphe,oPC))         return GetLocalInt(oMod,"DEITY_Siamorphe");
    if (GetHasFeat(DEITY_Silvanus,oPC))          return GetLocalInt(oMod,"DEITY_Silvanus");
    if (GetHasFeat(DEITY_Sune,oPC))              return GetLocalInt(oMod,"DEITY_Sune");
    if (GetHasFeat(DEITY_Talona,oPC))            return GetLocalInt(oMod,"DEITY_Talona");
    if (GetHasFeat(DEITY_Talos,oPC))             return GetLocalInt(oMod,"DEITY_Talos");
    if (GetHasFeat(DEITY_Tempus,oPC))            return GetLocalInt(oMod,"DEITY_Tempus");
    if (GetHasFeat(DEITY_Torm,oPC))              return GetLocalInt(oMod,"DEITY_Torm");
    if (GetHasFeat(DEITY_Tymora,oPC))            return GetLocalInt(oMod,"DEITY_Tymora");
    if (GetHasFeat(DEITY_Tyr,oPC))               return GetLocalInt(oMod,"DEITY_Tyr");
    if (GetHasFeat(DEITY_Ulutiu,oPC))            return GetLocalInt(oMod,"DEITY_Ulutiu");
    if (GetHasFeat(DEITY_Umberlee,oPC))          return GetLocalInt(oMod,"DEITY_Umberlee");
    if (GetHasFeat(DEITY_Underdark_Powers,oPC))  return GetLocalInt(oMod,"DEITY_Underdark_Powers");
    if (GetHasFeat(DEITY_Valkur,oPC))            return GetLocalInt(oMod,"DEITY_Valkur");
    if (GetHasFeat(DEITY_Velsharoon,oPC))        return GetLocalInt(oMod,"DEITY_Velsharoon");
    if (GetHasFeat(DEITY_Waukeen,oPC))           return GetLocalInt(oMod,"DEITY_Waukeen");
    if (GetHasFeat(DEITY_Xvim,oPC))              return GetLocalInt(oMod,"DEITY_Xvim");
    return 0;
}
...
string TE_GetLocationName(string sLoc)
{
    if (sLoc == "")                 return "nonexistent.";
    if (sLoc == "WP_Whipinn")       return "Whippoorwill Inn.";
    if (sLoc == "WP_Lockfalls")     return "Lockwood Falls.";
    if (sLoc == "WP_Swamprise")     return "Swamprise Keep.";
    if (sLoc == "WP_Southspire")    return "Southspire Hold.";
    return "Failed";
}
...
// Returns TRUE or FALSE if nClass is a listed arcane caster class
int TE_ArcaneCasterClass(int nClass)
{
    return (
        nClass == CLASS_TYPE_ARTIFICER ||
        nClass == CLASS_TYPE_ASSASSIN ||
        nClass == CLASS_TYPE_BARD ||
        nClass == CLASS_TYPE_BLADESINGER ||
        nClass == CLASS_TYPE_ELDRITCH_KNIGHT ||
        nClass == CLASS_TYPE_HARPER ||
        nClass == CLASS_TYPE_MYSTIC_KNIGHT ||
        nClass == CLASS_TYPE_PALE_MASTER ||
        nClass == CLASS_TYPE_PALEMASTER ||
        nClass == CLASS_TYPE_SPELLFIRE ||
...
// Returns TRUE or FALSE if nClass is a listed divine caster class
int TE_DivineCasterClass(int nClass)
{
    return (
        nClass == CLASS_TYPE_BLACKGUARD ||
        nClass == CLASS_TYPE_BLACKCOAT ||
...
int TE_GetCasterLevel(object oPC, int nClass)
{
    ...
    if(GetIsPC(oPC) != TRUE || GetIsDMPossessed(oPC))
    {
...
int TE_GetSpellSaveDC(object oPC, int nSpell, int nClass)
{
    ...
    {
        if (GetHasFeat(FEAT_SPELL_FOCUS_ABJURATION,oPC))
        {
            nMod2 = 2;
        }
        else if (GetHasFeat(FEAT_GREATER_SPELL_FOCUS_ABJURATION,oPC))
        {
            nMod2 = 4;
        }
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_ABJURATION,oPC))
        {
            nMod2 = 6;
        }
    ...
    {
        if (GetHasFeat(FEAT_SPELL_FOCUS_CONJURATION,oPC))
        {
            nMod2 = 2;
        }
        ...
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_CONJURATION,oPC))
        {
            nMod2 = 6;
        }
    ...
    {
        if (GetHasFeat(FEAT_SPELL_FOCUS_DIVINATION,oPC))
        {
            nMod2 = 2;
        }
        else if (GetHasFeat(FEAT_GREATER_SPELL_FOCUS_DIVINATION,oPC))
        {
            nMod2 = 4;
        }
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_DIVINATION,oPC))
        {
            nMod2 = 6;
        }
    ...
    if(nSchool == SPELL_SCHOOL_ENCHANTMENT)
    {
        ...
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_ENCHANTMENT,oPC))
        {
            nMod2 = 6;
        }
    ...
    {
        if (GetHasFeat(FEAT_SPELL_FOCUS_ILLUSION,oPC))
        {
            nMod2 = 2;
        }
        ...
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_ILLUSION,oPC))
        {
            nMod2 = 6;
        }
    ...
    if(nSchool == SPELL_SCHOOL_NECROMANCY)
    {
        ...
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_NECROMANCY,oPC))
        {
            nMod2 = 6;
        }
        if(GetHasFeat(1300,OBJECT_SELF))
    ...
    {
        if (GetHasFeat(FEAT_SPELL_FOCUS_TRANSMUTATION,oPC))
        {
            nMod2 = 2;
        }
        else if (GetHasFeat(FEAT_GREATER_SPELL_FOCUS_TRANSMUTATION,oPC))
        {
            nMod2 = 4;
        }
        else if (GetHasFeat(FEAT_EPIC_SPELL_FOCUS_TRANSMUTATION,oPC))
        {
            nMod2 = 6;
        }
...
int GetHasBackground(object oPC)
{
    // cleaner method (-LordValinar 10/27/2023)
    int i; for (i=1153; i<= 1471; i++)
    {
        if (i>1174 && i<1185) continue;
        if (i>1185 && i<1389) continue;
        if (i>1401 && i<1460) continue;
        if (GetHasFeat(i,oPC)) return TRUE;
    }
    return FALSE;
}
...
int GetIsClassPRC(int nClass)
{
    ...
    switch (nClass)
    {
        ...
        case 37: case 41: case 49: case 50: case 51:
        case 52: case 53: case 54: case 55: return TRUE;
    }
    return FALSE;
}
...
int TE_GetDeity(object oPC)
{
    ...
    else if (GetHasFeat(DEITY_Amaunator,oPC))
    {
        return DEITY_Amaunator;
    }
    else if (GetHasFeat(DEITY_Auril,oPC))
    {
        return DEITY_Auril;
    }
    else if (GetHasFeat(DEITY_Bane,oPC))
    {
        return DEITY_Bane;
    }
    else if (GetHasFeat(DEITY_Beshaba,oPC))
    {
        return DEITY_Beshaba;
    }
    else if (GetHasFeat(DEITY_Bhaal,oPC))
    {
        return DEITY_Bhaal;
    }
    else if (GetHasFeat(DEITY_Chauntea,oPC))
    {
        return DEITY_Chauntea;
    }
    else if (GetHasFeat(DEITY_Cyric,oPC))
    {
        return DEITY_Cyric;
    }
    else if (GetHasFeat(DEITY_Deneir,oPC))
    {
        return DEITY_Deneir;
    }
    else if (GetHasFeat(DEITY_Dwarven_Powers,oPC))
    {
        return DEITY_Dwarven_Powers;
    }
    else if (GetHasFeat(DEITY_Eldath,oPC))
    {
        return DEITY_Eldath;
    }
    else if (GetHasFeat(DEITY_Elven_Powers,oPC))
    {
        return DEITY_Elven_Powers;
    }
    else if (GetHasFeat(DEITY_Finder_Wyvernspur,oPC))
    {
        return DEITY_Finder_Wyvernspur;
    }
    else if (GetHasFeat(DEITY_Garagos,oPC))
    {
        return DEITY_Garagos;
    }
    else if (GetHasFeat(DEITY_Gargauth,oPC))
    {
        return DEITY_Gargauth;
    }
    else if (GetHasFeat(DEITY_Gnomish_Powers,oPC))
    {
        return DEITY_Gnomish_Powers;
    }
    else if (GetHasFeat(DEITY_Gond,oPC))
    {
        return DEITY_Gond;
    }
    else if (GetHasFeat(DEITY_Grumbar,oPC))
    {
        return DEITY_Grumbar;
    }
    else if (GetHasFeat(DEITY_Gwaeron_Windstrom,oPC))
    {
        return DEITY_Gwaeron_Windstrom;
    }
    else if (GetHasFeat(DEITY_Halfling_Powers,oPC))
    {
        return DEITY_Halfling_Powers;
    }
    else if (GetHasFeat(DEITY_Helm,oPC))
    {
        return DEITY_Helm;
    }
    else if (GetHasFeat(DEITY_Hoar,oPC))
    {
        return DEITY_Hoar;
    }
    else if (GetHasFeat(DEITY_Ibrandul,oPC))
    {
        return DEITY_Ibrandul;
    }
    else if (GetHasFeat(DEITY_Ilmater,oPC))
    {
        return DEITY_Ilmater;
    }
    else if (GetHasFeat(DEITY_Ishtisha,oPC))
    {
        return DEITY_Ishtisha;
    }
    else if (GetHasFeat(DEITY_Jergal,oPC))
    {
        return DEITY_Jergal;
    }
    else if (GetHasFeat(DEITY_Karsus,oPC))
    {
        return DEITY_Karsus;
    }
    else if (GetHasFeat(DEITY_Kelemvor,oPC))
    {
        return DEITY_Kelemvor;
    }
    else if (GetHasFeat(DEITY_Kossuth,oPC))
    {
        return DEITY_Kossuth;
    }
    else if (GetHasFeat(DEITY_Lathander,oPC))
    {
        return DEITY_Lathander;
    }
    else if (GetHasFeat(DEITY_Leira,oPC))
    {
        return DEITY_Leira;
    }
    else if (GetHasFeat(DEITY_Lliira,oPC))
    {
        return DEITY_Lliira;
    }
    else if (GetHasFeat(DEITY_Loviatar,oPC))
    {
        return DEITY_Loviatar;
    }
    else if (GetHasFeat(DEITY_Lurue,oPC))
    {
        return DEITY_Lurue;
    }
    else if (GetHasFeat(DEITY_Malar,oPC))
    {
        return DEITY_Malar;
    }
    else if (GetHasFeat(DEITY_Mask,oPC))
    {
        return DEITY_Mask;
    }
    else if (GetHasFeat(DEITY_Mielikki,oPC))
    {
        return DEITY_Mielikki;
    }
    else if (GetHasFeat(DEITY_Milil,oPC))
    {
        return DEITY_Milil;
    }
    else if (GetHasFeat(DEITY_Moander,oPC))
    {
        return DEITY_Moander;
    }
    else if (GetHasFeat(DEITY_Myrkul,oPC))
    {
        return DEITY_Myrkul;
    }
    else if (GetHasFeat(DEITY_Mystra,oPC))
    {
        return DEITY_Mystra;
    }
    else if (GetHasFeat(DEITY_Nobanion,oPC))
    {
        return DEITY_Nobanion;
    }
    else if (GetHasFeat(DEITY_Oghma,oPC))
    {
        return DEITY_Oghma;
    }
    else if (GetHasFeat(DEITY_Orcish_Powers,oPC))
    {
        return DEITY_Orcish_Powers;
    }
    else if (GetHasFeat(DEITY_Red_Knight,oPC))
    {
        return DEITY_Red_Knight;
    }
    else if (GetHasFeat(DEITY_Savras,oPC))
    {
        return DEITY_Savras;
    }
    else if (GetHasFeat(DEITY_Selune,oPC))
    {
        return DEITY_Selune;
    }
    else if (GetHasFeat(DEITY_Shar,oPC))
    {
        return DEITY_Shar;
    }
    else if (GetHasFeat(DEITY_Sharess,oPC))
    {
        return DEITY_Sharess;
    }
    else if (GetHasFeat(DEITY_Shaundakul,oPC))
    {
        return DEITY_Shaundakul;
    }
    else if (GetHasFeat(DEITY_Shiallia,oPC))
    {
        return DEITY_Shiallia;
    }
    else if (GetHasFeat(DEITY_Siamorphe,oPC))
    {
        return DEITY_Siamorphe;
    }
    else if (GetHasFeat(DEITY_Silvanus,oPC))
    {
        return DEITY_Silvanus;
    }
    else if (GetHasFeat(DEITY_Sune,oPC))
    {
        return DEITY_Sune;
    }
    else if (GetHasFeat(DEITY_Talona,oPC))
    {
        return DEITY_Talona;
    }
    else if (GetHasFeat(DEITY_Talos,oPC))
    {
        return DEITY_Talos;
    }
    else if (GetHasFeat(DEITY_Tempus,oPC))
    {
        return DEITY_Tempus;
    }
    else if (GetHasFeat(DEITY_Torm,oPC))
    {
        return DEITY_Torm;
    }
    else if (GetHasFeat(DEITY_Tymora,oPC))
    {
        return DEITY_Tymora;
    }
    else if (GetHasFeat(DEITY_Tyr,oPC))
    {
        return DEITY_Tyr;
    }
    else if (GetHasFeat(DEITY_Ulutiu,oPC))
    {
        return DEITY_Ulutiu;
    }
    else if (GetHasFeat(DEITY_Umberlee,oPC))
    {
        return DEITY_Umberlee;
    }
    else if (GetHasFeat(DEITY_Underdark_Powers,oPC))
    {
        return DEITY_Underdark_Powers;
    }
    else if (GetHasFeat(DEITY_Valkur,oPC))
    {
        return DEITY_Valkur;
    }
    else if (GetHasFeat(DEITY_Velsharoon,oPC))
    {
        return DEITY_Velsharoon;
    }
    else if (GetHasFeat(DEITY_Waukeen,oPC))
    {
        return DEITY_Waukeen;
    }
    else if (GetHasFeat(DEITY_Xvim,oPC))
    {
        return DEITY_Xvim;
    }
    else
...
// ChangeFactionReputation() removed and TE_Faction_Fix
// adjusted to run off of lv_factions_inc functions
// - LordValinar (10/26/2023)

void TE_Faction_Fix(object oPC)
{
    int bNature = ((GetLevelByClass(CLASS_TYPE_DRUID,oPC) >= 3 || GetLevelByClass(CLASS_TYPE_RANGER,oPC) >= 3) && GetLevelByClass(CLASS_TYPE_BLIGHTER,oPC) < 1);
    SetLocalInt(oPC, "FAC_UNDEAD", GetIsUndead(oPC));
    SetLocalInt(oPC, "FAC_NATURE", bNature);
    SetLocalInt(oPC, "FAC_AFFLICTION", GetPCAffliction(oPC));
    SetLocalInt(oPC, "FAC_CHOICE", 6); // Faction Reset
    ExecuteScript("lv_faction_exe", oPC);
}

// =============================================================================
/* Added functions (LordValinar - 10/05/2023) */

// Returns an integer value for the target's wounds.
// * Returns 0 for "Uninjured", 1 for "Barely Injured", 2 for "Injured"
//   3 for "Badly Wounded", 4 for "Near Death", and 5 for "Dead"
int GetWoundLevel(object oTarget);
int GetWoundLevel(object oTarget)
{
    object oRevive = GetLocalObject(oTarget, "oOwner");
    if (GetIsObjectValid(oRevive) && GetLocalInt(oTarget, "nUndead") != 1)
    {
        return 5; // Dead Player (placeable)
    }
    int nLoss = GetPercentageHPLoss(oTarget);
    if (nLoss > 94) return 0; // Uninjured
    if (nLoss > 74) return 1; // Barely Injured
    if (nLoss > 49) return 2; // Injured
    if (nLoss > 24) return 3; // Badly Wounded
    if (nLoss >= 0) return 4; // Near Death | Dying
    return -1;
}
